...
const handleApplyPreset = (index: number) => {
  ...
  const getSearchResults = () => {
    ...
    const stations = [
      { id: "home", category: "workstation", titleVi: "Trang Chủ (Workspace Resume)", titleEn: "Home Workspace", descVi: "Tổng quan công việc, tiếp tục bản thảo và khôi phục phiên làm việc", descEn: "Overview, resume drafts, and session recovery", action: () => { setActiveTab("home"); setShowSearchModal(false); } },
      { id: "create", category: "workstation", titleVi: "Trạm Soạn Thảo (Studio Desk)", titleEn: "Studio Desk (Create)", descVi: "Soạn kịch bản, đọc báo RSS, phát sinh bản tin phát thanh AI", descEn: "Draft scripts, read RSS, generate AI radio briefings", action: () => { setActiveTab("create"); setCreateSubTab("editor"); setShowSearchModal(false); } },
      { id: "rss", category: "workstation", titleVi: "Đọc Báo RSS", titleEn: "RSS Channels Reader", descVi: "Xem các nguồn tin RSS và tổng hợp tự động", descEn: "Browse RSS feeds and aggregate content", action: () => { setActiveTab("create"); setCreateSubTab("rss"); setShowSearchModal(false); } },
      { id: "intelligence", category: "workstation", titleVi: "Thư Viện Phát & Lưu Trữ (Media Library)", titleEn: "Media Library & Playlists", descVi: "Quản lý bản tin đã lưu, hàng đợi phát và kênh Podcast", descEn: "Manage play queue, saved briefings, and podcast publishing", action: () => { setActiveTab("intelligence"); setActiveLibrarySubTab("briefings"); setShowSearchModal(false); } },
      { id: "podcast", category: "workstation", titleVi: "Nhà Xuất Bản Podcast", titleEn: "Podcast Publisher Portal", descVi: "Xuất bản bản tin lên feed Podcast công cộng", descEn: "Publish compiled episodes to public RSS feeds", action: () => { setActiveTab("intelligence"); setActiveLibrarySubTab("podcast"); setShowSearchModal(false); } },
      { id: "queue", category: "workstation", titleVi: "Hàng Đợi Nghe Thông Minh", titleEn: "Smart Play Queue", descVi: "Sắp xếp thứ tự danh sách phát bản tin offline", descEn: "Arrange offline playback order and playlist history", action: () => { setActiveTab("intelligence"); setActiveLibrarySubTab("queue"); setShowSearchModal(false); } },
      { id: "stats", category: "workstation", titleVi: "Thống Kê Thói Quen Nghe", titleEn: "Listening Analytics", descVi: "Phân tích thời lượng nghe, dung lượng lưu trữ offline", descEn: "Analyze play time and cached storage metrics", action: () => { setActiveTab("intelligence"); setActiveLibrarySubTab("storage"); setShowSearchModal(false); } },
